"""Ejemplo de aplicación de las convenciones de estilo PEP 8 en Python. Este código sigue las recomendaciones de PEP 8 para mejorar la legibilidad y mantenibilidad del código."""
